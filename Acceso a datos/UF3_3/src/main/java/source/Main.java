...
public class Main {
	...
	public static void main(String[] args) {
		...
		EntityManagerFactory emf = Persistence.createEntityManagerFactory("Persistenciaaa");		//CLASE QUE ABRE LA CONEXION A LA BBDD
		...
		//CREAMOS DIRECCIONES Y LAS ASIGNAMOS DONDE CORRESPONDAN (eX-> EDITORIAL ----- libreriaX-> LIBRERIA)
		...
		//SE AÑADE CADA LIBRO A LA LISTA DE LIBROS (LISTA POR AUTOR) A LA QUE PERTENEZCA
		...
		//SE ASIGNA UNA LISTA DE LIBROS A CADA AUTOR (AUTOR ESCRIBE LIBROS QUE SE PRESENTAN EN UNA LISTA)
		...
		//AÑADIMOS CADA LIBRO A LA LISTA QUE CORRESPONDA (CADA EDITORIAL TIENE MUCHOS LIBROS QUE ESTAN EN UNA LISTA)
		libe1.add(l7);//ed1
		libe1.add(l2);
		libe1.add(l5);
		libe1.add(l6);
		...
		//AÑADIMOS CADA LIBRO A LA LIBRERIA EN LA QUE SE ENCUENTRE (CADA LIBRERIA TIENE UNA LISTA DE LIBROS CON LOS QUE TRABAJA)
		...
		//AÑADIMOS CADA LIBRERIA A CADA LIBRO (UN LIBRO SE PUEDE ENCONTRAR EN LIBRERIAS)
        ...
        do {
            ...
            if(option.equals("1")) {
        		...
        		//SQL PARA SACAR EL LIBRO CON SU AUTOR Y LA EDITORIAL EN LA QUE SE ENCUENTRA PUBLICADO
        		List<Libro> consulta1 = em.createQuery("from Libro l").getResultList();
        		for(Libro l : consulta1) {
        			System.out.println("El libro: " + l.getTitulo() + " tiene como autor a: " + l.getAutor().getNombre() + " "+ l.getAutor().getApellidos()
        					+ " y se encuentra publicado en la editorial: " + l.getEditorial().getNombre());
        		}
        		...
        		for(Autor a : consulta2) {
        			System.out.println("El autor: " + a.getNombre() + " " + a.getApellidos() + " ha escrito los siguientes libros: " );
        		...
        		//COMANDO PARA OBTENER LOS LIBROS DADOS DE ALTA Y LA LIBRERIA EN LA QUE LOS PODEMOS ENCONTRAR
