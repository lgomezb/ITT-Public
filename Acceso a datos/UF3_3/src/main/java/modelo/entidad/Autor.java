...
public class Autor {
	...
	/*
	 * The attribute [libros] in entity class [class modelo.entidad.Autor] has a
	 * mappedBy value of [autores] which does not exist in its owning entity class
	 * [class modelo.entidad.Libro]. If the owning entity class is
	 * a @MappedSuperclass, this is invalid, and your attribute should reference the
	 * correct subclass.
	 */
