...
public class Window extends JFrame {
	...
	private JLabel numberOne, numberTwo, result, image, light;
	...
	public Window() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage("src/currency-calculator.png")); //Añadimos el icono de la ventana
		setLayout(null);
		initComponents();
		setVisible(true);
	...
	/**
	 * Función que elimina el color a los botones (Fondo y Color de letra)
	 */
	...
	private void initComponents() {
		...
		numberOne.setFont(new Font("Cooper Black", Font.PLAIN, 16)); // .setFont Establecer la fuente de la caja. 1.Tipo de letra, 2.Estilo de letra, 3.Tamaño de letra
		numberOne.setForeground(Color.BLACK); // .setForeground Método que da color a las letras
		add(numberOne); 
		...
		boxOne.setBackground(Color.BLACK);  // .setBackground Método que cambia el fondo
		boxOne.setForeground(getBackground());
		boxOne.setBorder(null); // .setBorder Método que establece los bordes del componente
		add(boxOne);
		...
		result.setBounds(70, 450, 300, 30);
		...
		/**
		 * Método que se pone a la espera de acciones realizadas por el cursor del ratón
		 */
		light.addMouseListener(new MouseListener() {

			/**
			 * Se invoca cuando el ratón clica sobre el objeto JLabel light
			 */
			@Override
			public void mouseClicked(MouseEvent e) { 
				...
				addition.addMouseListener(new MouseListener() {
					/**
					 * Se invoca cuando el ratón clica sobre el objeto JButton addition
					 */
					@Override
					...
					/**
					 *  Se invoca cuando el puntero se posiciona sobre el botón Addition
					 */
					@Override
					...
					/**
					 *  Se invoca cuando el puntero se posiciona fuera de el botón Addition 
					 */
					@Override
					...
					/**
					 * Se invoca cuando el ratón se mantiene presionado el botón addition
					 */
					@Override
					public void mousePressed(MouseEvent e) {				
					}
					/**
					 * Se invoca cuando se suelta después de haber mantenido pulsado el botón addition
					 */
					@Override
				...
				subtraction.addMouseListener(new MouseListener() {
					/**
					 *  Se invoca cuando el puntero se posiciona sobre el botón subtraction
					 */
					@Override
					public void mouseClicked(MouseEvent arg0) {
						if(!clickeds) {
					...
					/**
                     *  Se invoca cuando el puntero se posiciona fuera de el botón subtraction 
                     */
					@Override
					...
					/**
                     * Se invoca cuando el ratón se mantiene presionado el botón subtraction
                     */
					@Override
					public void mousePressed(MouseEvent arg0) {						
					}
					/**
                     * Se invoca cuando se suelta después de haber mantenido pulsado el botón subtraction
                     */
					@Override
				...
				multiplication.addMouseListener(new MouseListener() {
					/**
					 *  Se invoca cuando el puntero se posiciona sobre el botón Multiplication
					 */
					@Override
					public void mouseClicked(MouseEvent e) {
						if(!clickedm) {
					...
					/**
                     *  Se invoca cuando el puntero se posiciona fuera de el botón Multiplication 
                     */
					@Override
					public void mouseExited(MouseEvent e) {
						if(!clickedm) {
					...
					/**
                     * Se invoca cuando el ratón se mantiene presionado el botón multiplication
                     */
					@Override
					public void mousePressed(MouseEvent e) {
					...
					/**
                     * Se invoca cuando se suelta después de haber mantenido pulsado el botón multiplication
                     */
					@Override
					public void mouseReleased(MouseEvent e) {
				...
				division.addMouseListener(new MouseListener() {
					/**
					 *  Se invoca cuando el puntero se posiciona sobre el botón Division
					 */
					@Override
					public void mouseClicked(MouseEvent e) {
						if(!clickedd) {
					...
					/**
                     *  Se invoca cuando el puntero se posiciona fuera de el botón Division 
                     */
					@Override
					public void mouseExited(MouseEvent e) {
						if(!clickedd) {
					...
					/**
                     * Se invoca cuando el ratón se mantiene presionado el botón Division
                     */
					@Override
					public void mousePressed(MouseEvent e) {
					...
					/**
                     * Se invoca cuando se suelta después de haber mantenido pulsado el botón division
                     */
					@Override
					public void mouseReleased(MouseEvent e) {
						// TODO Auto-generated method stub
			...
			/**
             * Se invoca cuando el ratón se mantiene presionado la etiqueta light
             */
			@Override
			public void mousePressed(MouseEvent e) {				
			}
			/**
             * Se invoca cuando se suelta después de haber mantenido pulsado la etiqueta light
             */
			@Override
			public void mouseReleased(MouseEvent e) {
			}});
